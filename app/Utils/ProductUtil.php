...
class ProductUtil extends Util
{
    ...
    public function updateProductQuantity1($location_id, $product_id, $variation_id,$id, $new_quantity, $old_quantity = 0, $number_format = null, $uf_data = true)
    {
        if ($uf_data) {
            $qty_difference = $this->num_uf($new_quantity, $number_format) - $this->num_uf($old_quantity, $number_format);
        } else {
    ...
    public function incrementProductQuantity($product_id, $variation_id, $location_id, $new_quantity, $old_quantity = 0)
    {
        $qty_difference = $new_quantity + $old_quantity;
