...
class CashRegisterController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $close_time_regis=$register_details['close_time_regis'];
        $close_time = \Carbon::now()->toDateTimeString();

        $details = $this->cashRegisterUtil->getRegisterTransactionDetails($user_id, $open_time, $close_time,$close_time_regis);
    ...
    public function showCash($id)
    {
        ...
        return view('cash_register.showCash')
                    ->with(compact('register_details', 'details', 'payment_types'));
    }
    /**
    ...
    public function getRegisterDetails()
    {
        ...
        $details = $this->cashRegisterUtil->getRegisterTransactionDetails($user_id, $open_time, $close_time,$close_time_regis, $is_types_of_service_enabled);
    ...
    public function postCloseRegister(Request $request)
    {
        try {
            ...
            $input['status'] = 'close';
            $idcash= CashRegister::where('user_id', $user_id)
            ->where('status', 'open')
           ->first();
        ...
        return redirect()
        ->action('CashRegisterController@showCash',['id' => $idcashenviar])
        ->with('status', $output);
        // return redirect()->action('HomeController@index')->with('status', $output);
    }
}
