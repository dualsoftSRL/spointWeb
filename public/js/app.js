$(document).ready(function() {
    ...
    $('.modal').on('shown.bs.modal', function() {
        ...
        $("#alternate_number").mask("(999) 999-9999");
        $("#landline").mask("(999) 999-9999");
    });
    ...
    $('.contact_modal').on('shown.bs.modal', function(e) {
        $("select[id='contact_type']").val($("input[id='contact_type']").val()).trigger('change');

        if($("select#tiene_credito").val()==0){
            $("div.numeropagos").hide();
            $("div.creditolimite").hide();
        }

        if ($('select#contact_type').val() == 'customer') {
            $('div.supplier_fields').hide();
            $('div.customer_fields').show();
            $('div.idncf_fields').show();

        } else if ($('select#contact_type').val() == 'supplier') {
            $('div.supplier_fields').show();
            $('div.customer_fields').hide();
            $('div.idncf_fields').hide();

        }
$("select#tiene_credito").change(function(){
var po=$(this).val();
if(po=='1'){
    $("div.numeropagos").fadeIn();
    $("div.creditolimite").fadeIn();
}else{
    $("div.numeropagos").fadeOut();
    $("div.creditolimite").fadeOut();
}
});
        $('select#contact_type').change(function() {
            ...
            if (t == 'supplier') {
                ...
                $('div.idncf_fields').fadeOut();

            } else if (t == 'both') {
                $('div.supplier_fields').fadeIn();
                $('div.customer_fields').fadeIn();
                $('div.idncf_fields').fadeIn();
