$(document).ready(function() {
    ...
    supplier_report_tbl1 = $('#supplier_report_tbl1').DataTable({
        processing: true,
        serverSide: true,
        stateSave: true,
        ajax: {
            url: '/reports/customer-CXC',
            data: function(d) {
                d.customer_group_id = $('#cnt_customer_group_id').val();
                d.contact_type = $('#contact_type').val();
            }
        ...
        columnDefs: [
            { targets: [5], orderable: false, searchable: true },
            { targets: [1, 2, 3, 4,6], searchable: true },
        ],
        columns: [
            { data: 'name', name: 'name' },
            { data: 'due', name: 'due' },
            { data: 'total_0_15', name: 'name' },
            { data: 'total_15_30', name: 'name' },
            { data: 'total_30_45', name: 'name' },
            { data: 'total_45_60', name: 'name' },
            { data: 'total_dias_mas_60', name: 'name' },
        ],
        fnDrawCallback: function(oSettings) {
            var footer_total_purchase = sum_table_col($('#supplier_report_tbl1'), 'total_due');
            $('#footer_total_purchase').text(footer_total_purchase);

            var total_0_15 = sum_table_col(
                $('#supplier_report_tbl1'),
                'total_0_15'
            );
            $('#footer_total_purchase_return').text(total_0_15);

            var total_sell = sum_table_col($('#supplier_report_tbl1'), 'total_15_30');
            $('#footer_total_sell').text(total_sell);

            var total_sell_return = sum_table_col($('#supplier_report_tbl1'), 'total_30_45');
            $('#footer_total_sell_return').text(total_sell_return);

            var total_45_60 = sum_table_col(
                $('#supplier_report_tbl1'),
                'total_45_60'
            );
            $('#footer_total_opening_bal_due').text(total_45_60);

            var total_dias_mas_60 = sum_table_col($('#supplier_report_tbl1'), 'total_dias_mas_60');
            $('#footer_total_due').text(total_dias_mas_60);

            __currency_convert_recursively($('#supplier_report_tbl1'));
        },
    });
    ...
    supplier_report_tbl2 = $('#supplier_report_tbl2').DataTable({
        processing: true,
        serverSide: true,
        stateSave: true,
        ajax: {
            url: '/reports/proveedores-CXP',
            data: function(d) {
                d.customer_group_id = $('#cnt_customer_group_id').val();
                d.contact_type = $('#contact_type').val();
            }
        ...
        fnDrawCallback: function(oSettings) {
            var footer_total_purchase = sum_table_col($('#supplier_report_tbl2'), 'total_due');
            $('#footer_total_purchase').text(footer_total_purchase);

            var total_0_15 = sum_table_col(
                $('#supplier_report_tbl2'),
                'total_0_15'
            );
            $('#footer_total_purchase_return').text(total_0_15);

            var total_sell = sum_table_col($('#supplier_report_tbl2'), 'total_15_30');
            $('#footer_total_sell').text(total_sell);

            var total_sell_return = sum_table_col($('#supplier_report_tbl2'), 'total_30_45');
            $('#footer_total_sell_return').text(total_sell_return);
            ...
            var total_dias_mas_60 = sum_table_col($('#supplier_report_tbl2'), 'total_dias_mas_60');
            $('#footer_total_due').text(total_dias_mas_60);

            __currency_convert_recursively($('#supplier_report_tbl2'));
        },
    });
    ...
    if($('#supplier_report_tbl2').length != 0){
        $("#contact_type").val('supplier').trigger('change');
        supplier_report_tbl2.ajax.reload();
