...
"prefix" => "Prefijo",
"desde" => "Desde",
"autorizacionNo" => "No. Autorización",
"fechavencimiento" => "Fecha Vencimiento",
"ncfcreate" => "NCF",
"Type" => "Tipo",
"manejocomprobante" => "Manejar Comprobante",
"sucuence_uso" => "Esta secuencia cae en el rango de otra vigente no se ha podido agregar",
"ncf_added_success" => "NCF Agregado exitósamente",
"hasta" => "Hasta",
"ncflist" => "Ncf",
"used" => "Usados",
"noautorizacion" => "No. Autorización",
"Ncf_successfully" => "Ncf creados exitósamente",
"date" => "Fecha_venc",
"add_ncf_secuencia" => "Agregar secuencias Ncf",
...
"secuencia" => "Secuencia",
"ncf1" => "Ncf",
"Secuencias_ncf" => "Secuencias Ncf",
"manage_Secuencias_ncf" => "Administra tus Ncf",
"all_your_ncf_secuence" => "Todas tus secuencias ncf",
