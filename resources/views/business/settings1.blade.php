...
{!! Form::open(['url' => action('BusinessController@postBusinessSettingssuperUser'), 'method' => 'post', 'id' => 'bussiness_edit_form',
           'files' => true ]) !!}
    <div class="row">
        <div class="col-xs-12">
       <!--  <pos-tab-container> -->
        <div class="col-xs-12 pos-tab-container">
            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 pos-tab-menu">
                <div class="list-group">
                    ...
                    <a href="#" class="list-group-item text-center">@lang('lang_v1.settings_import')</a>
            ...
            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10 pos-tab">
                ...
                @include('business.partials.settings_import')
    ...
    <div class="row">
        <div class="col-sm-12">
        <input type="text" name="business_prueba" value="{{$business->id}}">
