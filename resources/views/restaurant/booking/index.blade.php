...
@section('javascript')
    <script src="{{ asset('public/plugins/fullcalendar/fullcalendar.min.js?v=' . $asset_v) }}"></script>
@php
...
@if(file_exists(public_path() . '/plugins/fullcalendar/locale/' . $fullcalendar_lang_file))
    <script src="{{ asset('public/plugins/fullcalendar/locale/' . $fullcalendar_lang_file . '?v=' . $asset_v) }}"></script>
@endif
