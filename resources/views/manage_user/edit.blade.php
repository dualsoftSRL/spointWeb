...
<section class="content">
    ...
    <div class="row">
        ...
        @component('components.widget', ['title' => __('lang_v1.roles_and_permissions')])
            ...
            <div class="clearfix"></div>
        <div class="col-md-3">
          <h4>@lang( 'role.special_permissions' ) @show_tooltip(__('role.access_product'))</h4>
        </div>
         <div class="col-md-9"> 
         <div class="col-md-12">
            <div class="checkbox">
                <label>
                  {!! Form::checkbox('access_cost_product', 'Puede', !is_array($user->access_cost_product) && $user->access_cost_product == 'Puede', 
                ['class' => 'input-icheck']); !!} {{ __( 'role.access_edit_product' ) }} 
                </label>
            </div>
          </div> 
