			...
			<div class="row">
				...
				<div class="col-sm-3">
					<div class="form-group">
						...
						{!! Form::select('adjustment_type', [ 'normal' =>  __('stock_adjustment.incrementar'), 'abnormal' =>  __('stock_adjustment.disminuir')], null, ['class' => 'form-control select2', 'placeholder' => __('messages.please_select'), 'required']); !!}
					</div>
				</div>
			</div>
		</div>
...
@stop
@section('javascript')
	<script src="{{ asset('public/js/stock_adjustment.js?v=' . $asset_v) }}"></script>
@endsection
