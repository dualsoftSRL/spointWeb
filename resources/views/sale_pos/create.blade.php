			...
			@component('components.widget', ['class' => 'box-success'])
				...
				<div class="box-body">
					...
					<div class="row">
						<div class="@if(!empty($commission_agent)) col-sm-4 @else col-sm-6 @endif">
							<div class="form-group" style="width: 100% !important">
								<div class="input-group">
									...
									<input type="hidden" id="default_comp_id" 
									value="{{ $walk_in_customer['idncf']}}" >
									<input type="hidden" id="idcomp" 
							value="{{ $walk_in_customer['idncf']}}" >
						...
						<input type="hidden" value="customer" id="contact_type">
				...
				<div class="col-sm-4" id="codigomostrarncf">
					...
					<div class="form-group" hidden>
						...
						{!! Form::text('secuencia', null, ['class' => 'form-control', 'placeholder' => __('invoice.comprobante'),'value'=>'0']); !!}
					</div>
					<div class="form-group" hidden>
						{!! Form::label('idsecuencia', __('invoice.idsecuencia') . ':') !!}
						{!! Form::text('idsecuencia', null, ['class' => 'form-control', 'placeholder' => __('invoice.comprobante'),'value'=>'0']); !!}
					</div>
					<div class="form-group" hidden>
						{!! Form::label('vencencf', __('invoice.vencencf') . ':') !!}
						{!! Form::text('vencencf', null, ['class' => 'form-control', 'placeholder' => __('invoice.comprobante')]); !!}
					</div>
				</div>
...
$("#vencencf").val(result['fecha_venc']);
