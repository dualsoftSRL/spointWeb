...
<section class="content">
	...
	@component('components.widget', ['class' => 'box-primary'])
		<div class="row">
			<div class="col-sm-2">
			<div class="form-group">
					<button tabindex="-1" type="button" class="btn btn-primary btn-modal"data-href="{{action('ProductController@quickAdd_purchase')}}" 
            	data-container=".quick_add_product_modal"><i class="fa fa-hand-o-up"></i> @lang( 'product.select_product' ) </button>
				</div>
			</div>
			<div class="col-sm-2">
				<div class="form-group">
					<button tabindex="-1" type="button" class="btn btn-success btn-modal"data-href="{{action('ProductController@quickAdd')}}" 
