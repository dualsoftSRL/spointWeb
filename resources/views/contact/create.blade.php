      ...
      <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                {!! Form::text('name', null, ['class' => 'form-control','autofocus'=>'autofocus','placeholder' => __('contact.name'), 'required']); !!}
            </div>
        </div>
      </div>
      ...
      <div class="col-md-4">
        ...
        <div class="col-md-4 customer_fields">
          ...
          <label>Tiene Crédito</label>
              <br/>
            <select class="form-control" name="tiene_credito" id="tiene_credito">
        ...
        <div class="col-md-4 numeropagos">
          <div class="form-group">
            <div class="multi-input">
        ...
        <div class="col-md-4 creditolimite">
          <div class="form-group">
        ...
        @if(!isset($quick_add))
          <div class="col-sm-6 idncf_fields">
          <div class="form-group">
