            ...
            <div class="tab-content">
                <div class="tab-pane active" id="tab_1">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                {!! Form::label('print_receipt_on_invoice', __('receipt.print_receipt_on_invoice1') . ':') !!}
                                @show_tooltip(__('tooltip.print_receipt_on_invoice'))
                                <div class="input-group">
                                    <span class="input-group-addon">
                                        <i class="fa fa-file-text-o"></i>
                                    </span>
                                    {!! Form::select('printer_on', $printReceiptOnInvoice, $location->printer_on, ['class' => 'form-control select2', 'required']); !!}
                                </div>
                            </div>
                        </div>
