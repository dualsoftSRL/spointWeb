...
Route::middleware(['IsInstalled', 'bootstrap'])->group(function () {
    ...
    Route::get('/invoice/{token}', 'SellPosController@showInvoice')
        ->name('show_invoice');
        Route::get('/invoice1/{id}', 'SellPosController@showInvoice1')
        ->name('show_invoice1');
...
Route::middleware(['IsInstalled', 'auth', 'SetSessionData', 'language', 'timezone', 'bootstrap'])->group(function () {
    ...
    Route::post('/business/updatesuperuser', 'BusinessController@postBusinessSettingssuperUser')->name('business.postBusinessSettingssuperUser');
    ...
    Route::get('/contacts/CXC', 'ContactController@getCXC');
    ...
    Route::get('/contacts/showpaid/{contact_id}', 'ContactController@showpaid');
    Route::get('/contacts/showdetailcontact/{contact_id}', 'ContactController@showdetailcontact');
    ...
    Route::post('/visibility/select', 'ProductController@User_Verifiy');
    ...
    Route::get('/products/quick_add_purchase', 'ProductController@quickAdd_purchase');
    ...
    Route::get('/reports/customer-CXC', 'ReportController@getCXC');
    Route::get('/reports/proveedores-CXP', 'ReportController@getCXP');
    ...
    Route::get('ncf-list/activate-deactivate/{idncf}', 'NcfController@activateDeactivateLocation');
    Route::get('ncf-list/verificar/{idncf}/{desd}/{hast}', 'NcfController@verificar');
    Route::get('ncf-list/edit/{idncf}', 'NcfController@edit');
    ...
    // Route::get('/ncf', 'NcfController@index');
    ...
    Route::resource('ncf', 'NcfController');
    Route::get('ncf-list', 'NcfController@index');
    Route::get('Project-list/index', 'ProjectController@index');

    Route::get('project_create', 'ProjectController@create');
    Route::get('Task', 'ProjectController@Task');
    Route::get('add_task', 'ProjectController@add_task');
    Route::get('Task_list', 'ProjectController@Task_list');
    Route::post('/project_store', 'ProjectController@store');
    Route::post('/update_task', 'ProjectController@update_task');
    Route::post('/update_project', 'ProjectController@update_project');

    Route::post('/store_task', 'ProjectController@store_task');
    Route::post('/store_presupuesto', 'ProjectController@store_presupuesto');
    Route::get('project/show/{id}', 'ProjectController@show');
    Route::get('project/presupuesto/{id}', 'ProjectController@presupuesto');
    Route::get('project/presupuesto_details/{id}', 'ProjectController@presupuesto_details');
    Route::get('project/Edit_task/{id}', 'ProjectController@Edit_task');
    Route::get('project/edit_project/{id}', 'ProjectController@edit');
    Route::get('project/Show_task/{id}', 'ProjectController@Show_task');
    Route::get('project/Delete_task1/{id}', 'ProjectController@Delete_task1');
    Route::get('project/Delete_project/{id}', 'ProjectController@Delete_project');
    ...
    Route::get('/payments/Imprimir/{transaction_id}', 'TransactionPaymentController@Imprimir');

    Route::get('/payments/add_payment/{transaction_id}', 'TransactionPaymentController@addPayment');
    Route::get('/payments/Pagar/{transaction_id}', 'TransactionPaymentController@Pagar');
    ...
    Route::get('/showCash/{id}', 'CashRegisterController@showCash')
    ->name('showCash');
    ...
    Route::get('/sell/index1/{contact_id}', 'SellController@index1');
    
    Route::get('/sell/facturar/{contact_id}', 'SellController@create1');
    Route::get('/sell/ncfsecuencia/{idncf}', 'SellController@ncfsecuencia');
    Route::get('/sell/ncfcustomer/{idncf}', 'SellController@ncfcustomer');

    // Route::post('/my_route', array('as' => 'my_route', 'uses' => 'SellController@ncfsecuencia'));
